...
$res=mysqli_query($con,"select product.name,product.image,product.price,product.bdt,wishlist.id from product,wishlist where wishlist.product_id=product.id and wishlist.user_id='$uid'");
?>
										...
										?>
											<tr>
												...
												<td class="product-name"><a href="#"><?php echo $row['name']?></a>
													<ul  class="pro__prize">
														<li class="old__prize"><?php echo $row['bdt']?></li>
